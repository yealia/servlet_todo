                            ...
                            <div class="card-body">
                                <form action="/todo/add" method="post">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="memo"  id="inputEmail" type="text" placeholder="name@example.com" />
                                        <label for="inputEmail">memo</label>

                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" name="dueDate" id="inputPassword" type="text" placeholder="Create a password" />
                                                <label for="inputPassword">dueDate</label>
                                            </div>
                                        </div>
                                        <%--                    <div class="col-md-6">--%>
                                        <%--                      <div class="form-floating mb-3 mb-md-0">--%>
